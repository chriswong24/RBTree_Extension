# Assignment 8: Language Extension
#   By Christopher Wong and Luisa Neves
#   Red-Black Tree naive implementation in Ruby
#   Acquired from: https://github.com/headius/redblack/blob/master/red_black_tree.rb
